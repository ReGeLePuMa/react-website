...
function About() {
    return (
        <div id="about-me" className="w-screen h-screen flex min-[700px]:flex-row min-[300px]:flex-col bg-white z-20 p-4">
            <div className="min-[700px]:w-1/2 min-[300px]:w-full h-screen flex items-center justify-center">
                <img src={Photo} className="object-contain w-full h-full " alt="Your Photo" />
            </div>
            <div className="min-[700px]:w-1/2 min-[300px]:w-full flex flex-col items-center justify-center my-auto">
